    ...
    <div class="card-body">
        ...
        <form method="POST" id="edit" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="description" id="description" style="max-width: 400px"><?php echo $areaData['description'] ?></textarea>
            </div>
            <div class="form-group">
                ...
                <div class="image-area" style="width: 100%;max-width: 100%;text-align: center;">
                    <?php if(empty($areaData['share_image'])): ?>
                    ...
                    <?php else: ?>
                        <img style="width: auto; max-width: 100%" src="<?= BASE_URL ?>assets/images/categories/<?= $areaData['share_image'] ?>">
                    <?php endif; ?>
                </div>
            </div>
            <?php if(!empty($notice)):?>

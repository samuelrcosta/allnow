    ...
    <div class="card-body">
        ...
        <form method="POST" id="edit">
            ...
            <div class="form-group <?php echo(isset($advertisementData['media_type']) && $advertisementData['media_type'] != 3)?'div-invisible':''; ?>" id="div-image">
                ...
                <div class="progress">
                    <div id="progresso" class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"> Arquivo salvo
                    </div>
                </div>
                <input type="file" class="form-control" name="image" id="image" style="max-width: 400px;margin-top: 15px"  data-validation-allowing="jpg, png, jpeg" data-validation-max-size="2M" data-validation-error-msg="Insira um arquivo de imagem válido de até 2Mb" value="<?php echo(isset($advertisementData['image']))?$advertisementData['image']:''; ?>"/>
                <div class="image-area">
                    <h5>Pré-visulização da imagem:</h5>
                    <?php echo(isset($advertisementData['media']))?$advertisementData['media']:''; ?>
                </div>
            </div>
            <div class="form-group <?php echo(isset($advertisementData['media_type']) && $advertisementData['media_type'] == 3)?'div-invisible':''; ?>" id="div-link">
                <label for="media" class="form-control-label">link da mídia</label>
                <input class="form-control" name="media_link" id="media_link" style="max-width: 400px" data-validation="url" data-validation-error-msg="Insira o link de uma mídia" value="<?php echo(isset($advertisementData['media_link']))?$advertisementData['media_link']:''; ?>"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group" style="margin-bottom: 0">
                <input type="checkbox" name="highlight" id="highlight" class="filter_brand" style="margin-right: 5px" <?php echo(isset($advertisementData['highlight']) && $advertisementData['highlight'] == 1)?'checked':''; ?>> <label for="highlight">Irá aparecer nos destaques?</label>
            </div>
            <div class="form-group" style="margin-bottom: 0">

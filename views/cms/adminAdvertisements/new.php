    ...
    <div class="card-body">
        ...
        <form method="POST" id="register">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="id_category" id="id_category" style="max-width: 400px;background-position-x: 95%;" data-validation="required" data-validation-error-msg="Selecione uma Categoria">
                    <option></option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="id_subcategory" id="id_subcategory" style="max-width: 400px;background-position-x: 95%;" data-validation="required" data-validation-error-msg="Selecione uma Sub-Categoria">
            ...
            <div id="media_containers" style="margin-bottom: 20px">
                <div class="media-container" style="border: 1px solid;padding: 10px;">
                    <div class="form-group">
...
<script type="text/template" id="template-new-media">
    <div class="media-container" style="border: 1px solid;padding: 10px;margin-top: 15px">
        <div class="form-group">
            <label for="media_type" class="form-control-label">Tipo de Mídia</label>
            <select class="form-control" name="media_type" style="max-width: 400px;background-position-x: 95%;" data-validation="required" data-validation-error-msg="Selecione o tipo da mídia">
                <option value=""></option>
...
<script src="<?php echo BASE_URL ?>assets/js/controllers/adsCreatorController.js"></script>
<script>
    PageController.start('<?php echo BASE_URL ?>');
</script>
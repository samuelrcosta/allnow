<div class="container">
    ...
    <form method="POST" id="edit">
        ...
        <div class="form-group <?php echo(isset($advertisementData['media_type']) && $advertisementData['media_type'] != 3)?'div-invisible':''; ?>" id="div-image">
            ...
            <input type="file" class="form-control" name="image" id="image" style="max-width: 400px" data-validation-allowing="jpg, png, jpeg" data-validation-max-size="2M" data-validation-error-msg="Insira um arquivo de imagem válido de até 2Mb" value="<?php echo(isset($advertisementData['image']))?$advertisementData['image']:''; ?>"/>

            <div class="image-area">
                <?php echo(isset($advertisementData['media']))?$advertisementData['media']:''; ?>
            </div>
        </div>
        <div class="form-group <?php echo(isset($advertisementData['image']) || (isset($advertisementData['media_type']) && $advertisementData['media_type'] == 3))?'div-invisible':''; ?>" id="div-link">
            <label for="media" class="form-control-label">Link da Mídia</label>
            <input class="form-control" name="media_link" id="media_link" style="max-width: 400px" data-validation-error-msg="Insira o link de uma mídia" value="<?php echo(isset($advertisementData['media_link']))?$advertisementData['media_link']:''; ?>"/>
        </div>
        <div class="form-group">
        ...
        function renderizeImage() {
            ...
            if (image.length > 0) {
                ...
                if(resizeImage(image)){
                    ...
                    // Shows the error
                    $('#progresso').html('Arquivo de imagem inválido');
                }
            }
        }

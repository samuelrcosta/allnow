<div class="container">
    ...
    <form method="POST" id="register">
        ...
        <div class="form-group <?php echo(isset($media_type) && $media_type != 3)?'div-invisible':''; ?>" id="div-image">
            <div class="progress">
        ...
        <div class="form-group <?php echo(isset($image) || (isset($media_type) && $media_type == 3))?'div-invisible':''; ?>" id="div-link">
